...
public class PassordService {
    ...
    public boolean erKorrektPassord(
        ...
        if (passord == null) {
            throw new IllegalArgumentException("passord er null");
        } else if (salt == null) {
            throw new IllegalArgumentException("salt er null");
        } else if(hash == null) {
            throw new IllegalArgumentException("Hash er null");
